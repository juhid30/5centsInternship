...
const FeatureCard: FC<FeatureCardProps> = ({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-primary/10 from-primary/10 dark:to-primary/20 rounded-xl transform group-hover:scale-105 transition-transform duration-300" />
      <div className="card p-8 text-black  backdrop-blur-sm relative z-10 h-full border border-gray-100 dark:border-gray-700 hover:border-primary/20 dark:hover:border-primary/40 transition-colors duration-300">
        <div className="w-14 h-14 bg-primary/10 dark:bg-primary/20 rounded-2xl flex items-center justify-center mb-6 transform group-hover:rotate-6 transition-transform duration-300">
...
export default function Home() {
  ...
  return (
    <>
      <ThemeToggle />
      <div className="min-h-screen dark:bg-black bg-gradient-to-b from-gray-50 to-white">
        {/* Hero Section */}
        <motion.section
          ref={targetRef}
